...
intp_natural = NaturalNeighborsInterpolation.NaturalNeighborsInterpolator(points, values, fallback="natural")
interpolated_grid = interpolate_grid(xs, ys, intp_natural)
heatmap(interpolated_grid)
savefig("interpolated_grid_natural.png")

intp_natural = NaturalNeighborsInterpolation.NaturalNeighborsInterpolator(points, values, fallback="nan")
interpolated_grid = interpolate_grid(xs, ys, intp_natural)
heatmap(interpolated_grid)
